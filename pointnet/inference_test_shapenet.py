...
class ShapeNetDatasetEval(data.Dataset):
    def __init__(self,
        ...
        #using classes - cap(2), chair(4), lamp(8), laptop(9), mug(11), table(15)
        for cloud_index in [2,4,8,9,11,15]:
            ...
            for x in range(8):
                ...
                print(self.datapath[random_choice0][0])
                for h in range(8):
                    point_sets = []
                    #added_indeces = []
                    ...
                    for j in range(batch_size-1):
                        ...
                        while ((self.classes[self.datapath[random_choice1][0]] != cloud_index) or (random_choice1 == random_choice0)):
                            random_choice1 = np.random.choice(len(self.datapath))
                            #print("S")
                        point_cloud2 = self.datapath[random_choice1]
                        #print("X")
                        point_sets.append(point_cloud2)    
